 ...
 * Set config env
  ...
  * }
*/
async function getConfigEnvCargo(base_args) {
 ...
 * }
*/
async function getConfigEnvClientCargo(base_args) {
  ...
  for (let idx in values) {
    env_client[values[idx].client] = {
      storage: {
        type: values[idx].storage_type,
        config: JSON.parse(values[idx].storage_config).config
      },
    }
  }
